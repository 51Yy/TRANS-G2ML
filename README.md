...
Building on TransPolymer, TRANS-G2ML was adapted for polymeric mRNA delivery system modeling, with customized data processing, training, and downstream prediction modules. The model learns structure-aware polymer representations and is used to evaluate delivery performance and immune response profiles across polymer classes, mRNA cargos, and cell types.

Please refer to the original TransPolymer paper and repository for the foundational model architecture and environment setup.
